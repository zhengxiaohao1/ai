...
# # 普通norm和Mean
normMean = [123.675, 116.28, 103.53]
normStd = [58.395, 57.12, 57.375]

# resume = '/mnt/d/PyCharmProjects/openmmlab/mmpose/work_dirs/rtmpose-s_infraredhand-256x256_multihead_GCN/epoch_115.pth'
# optimizer
optim_wrapper = dict(
    type='OptimWrapper',
