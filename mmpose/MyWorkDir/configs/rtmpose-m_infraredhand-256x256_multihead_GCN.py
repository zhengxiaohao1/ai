...
# resume = '../tools/work_dirs/rtmpose-m_8xb32-210e_infraredhand-256x256/best_AUC_epoch_200.pth'
# # 普通norm和Mean
# normMean = [0.3270321, 0.3270318, 0.32703197]
# normStd = [0.2863983, 0.28639817, 0.28639823]
# model settings
model = dict(
    type='MyTopDown',
