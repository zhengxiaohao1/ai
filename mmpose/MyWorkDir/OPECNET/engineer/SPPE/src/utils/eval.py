...
try:
    ...
    from MyWorkDir.OPECNET.engineer.SPPE.src.utils.img import transformBoxInvert, transformBoxInvert_batch, findPeak, processPeaks,transformBox_batch
import torch
...
def getHighPosition(hms, pt1, pt2, inpH, inpW, resH, resW):
    '''
