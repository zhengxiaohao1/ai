...
class Alpha_SemGCN_FC_Attention(nn.Module):
    def __init__(self,adj,num_joints, hid_dim,model, outputResH,outputResW,inputResW,inputResH,coords_dim=(2, 2), p_dropout=None):
        '''
        ...
        super(Alpha_SemGCN_FC_Attention, self).__init__()
        ...
        self.generator = Alpha_Generator(model=model,outputResH=outputResH,outputResW=outputResW,inputResW=inputResW,inputResH=inputResH)
    ...
    def forward(self, inps, orig_img, im_name, boxes, scores, pt1, pt2,gts_list,dts_list):
        ...
        #generator produce
        dts, gt_2d, hm_4, ret_features = self.generator(inps,orig_img, im_name, boxes, scores, pt1, pt2,gts_list,dts_list)
